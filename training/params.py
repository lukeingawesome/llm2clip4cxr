...
def parse_args(args):
    ...
    parser.add_argument(
        "--text-base",
        type=str,
        default="lukeingawesome/llm2vec4cxr",
    ...
    parser.add_argument(
        "--pooling-mode",
        default="mean",
        choices=["mean", "latent_attention"],
        help="LLM2Vec pooling"
    )
    parser.add_argument(
        "--lock-image",
        default=False,
    ...
    parser.add_argument(
        ...
        default=True,
        action='store_true',
        help="Use LoRA adapters for text encoder (default: True)",
    )
    parser.add_argument(
        "--no-lora",
        dest="use_lora",
        action='store_false',
        help="Disable LoRA adapters for text encoder",
    )
    parser.add_argument(
        "--lora-r",
        type=int,
        default=16,
        help="LoRA rank for text model adapters",
    )
    parser.add_argument(
        "--lora-alpha",
        type=int,
        default=32,
        help="LoRA alpha parameter for text model adapters",
    )
    parser.add_argument(
        "--lora-dropout",
        type=float,
        default=0.1,
        help="LoRA dropout rate for text model adapters",
    )
    parser.add_argument(
        "--force-add-lora",
        default=False,
        action='store_true',
        help="Force add new LoRA adapters even if existing LoRA is detected",
    )
    parser.add_argument(
    ...
    # LoRA hyper-parameters for text tower
    parser.add_argument("--add-lora", action="store_true", help="Add LoRA adapters to text tower if not present")
